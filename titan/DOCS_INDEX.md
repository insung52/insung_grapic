...
- `drone_flight_dev_guide.md` (최종 2026-09-05) — **드론 시스템 에버그린 레퍼런스.** 로터별
  추력→강체운동 물리, 자율비행(Pure Pursuit+제동곡선), **교전 관측 이동(16절)**, 짐벌,
...
- `kadex_test_dashboard_wbp_spec.md` (2026-08, 최신) — **현재 실사용 위젯**
  ...
  를 대체하는 현재 UI 개발 기록.
- `graphics_settings_analysis.md` (2026-08-21, **팔로업 2026-09-03**) — 인게임 Settings 위젯
  Graphics 탭 사전조사. 09-03 팔로업(§0-2)에서 드론 교체·프레임상한 도입·cvar 우선순위 정정 등
  변경분 반영. **구현 대기.**
