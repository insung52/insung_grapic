...
배경은 `newlevel/new_kadex_0811_navmesh_autonomous_driving.md` 참고.
...
> `Birch_3_1` 삭제. 절차와 함정은 `path/new_kadex_0811_navmesh_autonomous_driving.md` 2절 참고.
...
`path/new_kadex_0811_navmesh_autonomous_driving.md` 2절 참고.
