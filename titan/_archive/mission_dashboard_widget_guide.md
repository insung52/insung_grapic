> [보관됨 2026-08-31] 최신 버전: `ui_dev_guide.md` §5/§8. 사유: `MissionDashboardWidget`/
> `WBP_test`는 검증용 스캐폴딩이었고, 실제 대시보드는 `Monitor1Widget`/`Monitor2Widget`
> (`WBP_kadex`)로 대체됨 — 현재 위젯 이름 기준은 `ui_dev_guide.md` §8 참고.
